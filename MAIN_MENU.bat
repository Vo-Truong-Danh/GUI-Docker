...
echo.
echo   [3] RUN SPARK JOB (Fixed script)
echo.
echo   [4] MONITOR SPARK JOB (Auto-refresh)
echo.
echo   [5] STOP ALL CONTAINERS
echo.
echo   [6] COMPACT DOCKER DISK (Free ~180 GB, need Admin)
echo.
echo   [7] SYSTEM INFO (Disk, containers, images, volumes)
echo.
echo   [8] ADVANCED MENU (More options)
echo.
echo   [9] EXIT
echo.
echo ========================================================================
...
if %CHOICE%==3 goto RUN_JOB
if %CHOICE%==4 goto MONITOR_JOB
if %CHOICE%==5 goto STOP_ALL
if %CHOICE%==6 goto COMPACT_DISK
if %CHOICE%==7 goto SYSTEM_INFO
if %CHOICE%==8 goto ADVANCED_MENU
if %CHOICE%==9 goto EXIT

:CLEAN_DATA
call CLEAN_DATA_MENU.bat
goto MAIN

:START_APP
call START_APP_SMART.bat
goto MAIN
...
echo.
echo ========================================================================
echo   COMPACT DOCKER DISK
echo ========================================================================
echo.
echo   WARNING: This requires ADMINISTRATOR privileges!
echo.
echo   Will free ~180 GB on C: drive
